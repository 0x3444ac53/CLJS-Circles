...
var vec__12476 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12476,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12476,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12476,(2),null);
var vec__12479 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12479,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12479,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12479,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__12482,p__12483){
var vec__12484 = p__12482;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12484,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12484,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12484,(2),null);
var vec__12487 = p__12483;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12487,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12487,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12487,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__12490_SHARP_){
return (p1__12490_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__12491_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__12492_SHARP_,angle_lr),angle_ud);
...
var map__12494 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12494__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12494__$1,cljs.core.cst$kw$straight);
var temp__5718__auto__ = (function (){var pred__12496 = cljs.core._EQ_;
var expr__12497 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__12499 = cljs.core.cst$kw$w;
var G__12500 = expr__12497;
return (pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(G__12499,G__12500) : pred__12496.call(null,G__12499,G__12500));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__12501 = cljs.core.cst$kw$s;
var G__12502 = expr__12497;
return (pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(G__12501,G__12502) : pred__12496.call(null,G__12501,G__12502));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__12497) : pred__12496.call(null,quil.middlewares.navigation_3d.space,expr__12497)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__12503 = cljs.core.cst$kw$z;
var G__12504 = expr__12497;
return (pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(G__12503,G__12504) : pred__12496.call(null,G__12503,G__12504));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__12505 = cljs.core.cst$kw$d;
var G__12506 = expr__12497;
return (pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(G__12505,G__12506) : pred__12496.call(null,G__12505,G__12506));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__12507 = cljs.core.cst$kw$a;
var G__12508 = expr__12497;
return (pred__12496.cljs$core$IFn$_invoke$arity$2 ? pred__12496.cljs$core$IFn$_invoke$arity$2(G__12507,G__12508) : pred__12496.call(null,G__12507,G__12508));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__5718__auto__,map__12494,map__12494__$1,up,straight){
return (function (p1__12493_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__12493_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__5718__auto__,map__12494,map__12494__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__12509_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__12510 = options;
var G__12511 = ((function (G__12510,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__12510,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__12510,G__12511) : rotate_on.call(null,G__12510,G__12511));
})();
...
var map__12512_12527 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__12512_12528__$1 = ((((!((map__12512_12527 == null)))?(((((map__12512_12527.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12512_12527.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12512_12527):map__12512_12527);
var vec__12513_12529 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12512_12528__$1,cljs.core.cst$kw$straight);
var c_x_12530 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12513_12529,(0),null);
var c_y_12531 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12513_12529,(1),null);
var c_z_12532 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12513_12529,(2),null);
var vec__12516_12533 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12512_12528__$1,cljs.core.cst$kw$up);
var u_x_12534 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12516_12533,(0),null);
var u_y_12535 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12516_12533,(1),null);
var u_z_12536 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12516_12533,(2),null);
var vec__12519_12537 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12512_12528__$1,cljs.core.cst$kw$position);
var p_x_12538 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12519_12537,(0),null);
var p_y_12539 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12519_12537,(1),null);
var p_z_12540 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12519_12537,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_12538,p_y_12539,p_z_12540,(p_x_12538 + c_x_12530),(p_y_12539 + c_y_12531),(p_z_12540 + c_z_12532),u_x_12534,u_y_12535,u_z_12536);
...
var G__12523 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__12524 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__12523,G__12524) : key_pressed.call(null,G__12523,G__12524));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__12525 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__12526 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__12525,G__12526) : rotate_on_fn.call(null,G__12525,G__12526));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
