...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__13032_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_13033 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_13034 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_13033);
var pos_13035 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_13033);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_13034);

var tr__12936__auto___13036 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_13034) - cljs.core.first(pos_13035)),(((quil.core.height() / (2)) / zoom_13034) - cljs.core.second(pos_13035))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__12936__auto___13036);
...
var G__13037 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__13038 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__13037,G__13038) : user_mouse_dragged.call(null,G__13037,G__13038));
...
return (function (state,event){
var G__13039 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__13040 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__13039,G__13040) : user_mouse_wheel.call(null,G__13039,G__13040));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
