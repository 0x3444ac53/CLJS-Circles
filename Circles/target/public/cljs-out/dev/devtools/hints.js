...
var line = cljs.core.get.call(null,map__12367__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12367__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12366){var _e = e12366;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___12369 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___12369)){
var seen_errors_12370 = temp__5718__auto___12369;
if(cljs.core.truth_(seen_errors_12370.has(self))){
} else {
seen_errors_12370.add(self);

var temp__5720__auto___12371 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___12371)){
var sense_12372 = temp__5720__auto___12371;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12372)].join('');
} else {
}
}
} else {
