...
var o9892 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9892["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9893 = temp__5718__auto____$1;
return (o9893["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9004__auto__ = f;
return (o__9004__auto__["toString"]).call(o__9004__auto__);
} else {
return "";
}
}catch (e9894){var _ = e9894;
return "";
}});
...
try{var o__9004__auto___9896 = t;
(o__9004__auto___9896["cljs$lang$ctorPrWriter"]).call(o__9004__auto___9896,t,writer);
}catch (e9895){var __9897 = e9895;
}
...
var char_code = (function (){var o__9004__auto__ = (new String(char$));
return (o__9004__auto__["charCodeAt"]).call(o__9004__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9004__auto__ = String;
return (o__9004__auto__["fromCharCode"]).call(o__9004__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9898 = num_code;
switch (G__9898) {
case (1):
return (185);
...
var o__9004__auto__ = String;
return (o__9004__auto__["fromCharCode"]).call(o__9004__auto__,superscript_code);
});
/**
...
}catch (e9900){var _e__9011__auto__ = e9900;
return false;
}})())){
...
var vec__9901 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9901,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o9904 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9904["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9905 = temp__5718__auto____$1;
return (o9905["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9908){
var vec__9909 = p__9908;
var ns_detector = cljs.core.nth.call(null,vec__9909,(0),null);
...
var G__9915 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9916 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9915;
remaining_tokens = G__9916;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9906){
var G__9907 = cljs.core.first.call(null,seq9906);
var seq9906__$1 = cljs.core.next.call(null,seq9906);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9907,seq9906__$1);
});
...
var vec__9920 = cljs.core.split_with.call(null,(function (p1__9919_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9919_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9920,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9920,(1),null);
...
var vec__9923 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9923,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9923,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9926 = cljs.core.rest.call(null,remaining_tokens);
var G__9927 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9926;
name_tokens = G__9927;
continue;
} else {
...
var vec__9930 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9930,(0),null);
var arity = cljs.core.nth.call(null,vec__9930,(1),null);
var vec__9933 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9933,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9933,(1),null);
var vec__9936 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9936,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9936,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9936,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9936,(3),null);
...
var vec__9942 = result;
var munged_ns = cljs.core.nth.call(null,vec__9942,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9942,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9942,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9942,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9942,(4),null);
var arity = cljs.core.nth.call(null,vec__9942,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9946 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9946,(0),null);
var args = cljs.core.nth.call(null,vec__9946,(1),null);
var vec__9949 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9949,(0),null);
var name = cljs.core.nth.call(null,vec__9949,(1),null);
...
var G__9952 = (arity + (1));
var G__9953 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9954){
var vec__9955 = p__9954;
var arity = cljs.core.nth.call(null,vec__9955,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9955,(1),null);
...
return cljs.core.get.call(null,arities,p1__9958_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9959_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___9966 = arguments.length;
var i__4532__auto___9967 = (0);
while(true){
if((i__4532__auto___9967 < len__4531__auto___9966)){
args__4534__auto__.push((arguments[i__4532__auto___9967]));

var G__9968 = (i__4532__auto___9967 + (1));
i__4532__auto___9967 = G__9968;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9962){
var vec__9963 = p__9962;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9963,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9960){
var G__9961 = cljs.core.first.call(null,seq9960);
var seq9960__$1 = cljs.core.next.call(null,seq9960);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9961,seq9960__$1);
});
...
var G__9969 = arg;
var G__9969__$1 = (((G__9969 instanceof cljs.core.Keyword))?G__9969.fqn:null);
switch (G__9969__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__9971__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9971__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9971__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9971__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9972 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9972,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9972,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9972,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9972,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9972,(4),null);
var arity = cljs.core.nth.call(null,vec__9972,(5),null);
...
var o__9004__auto__ = f;
return (o__9004__auto__["getBasis"]).call(o__9004__auto__);
});
/**
...
}catch (e9976){var _e__9011__auto__ = e9976;
...
var G__9977 = (obj[cljs.core.first.call(null,path)]);
var G__9978 = cljs.core.rest.call(null,path);
obj = G__9977;
path = G__9978;
continue;
} else {
...
return (function (accum,p__9979){
var vec__9980 = p__9979;
var bit = cljs.core.nth.call(null,vec__9980,(0),null);
var protocol = cljs.core.nth.call(null,vec__9980,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9983){
var vec__9984 = p__9983;
var ns = cljs.core.nth.call(null,vec__9984,(0),null);
var name = cljs.core.nth.call(null,vec__9984,(1),null);
var selector = cljs.core.nth.call(null,vec__9984,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__9989,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9989,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9989,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9987_SHARP_){
return (obj[cljs.core.first.call(null,p1__9987_SHARP_)]);
});})(name,sorted_matches,vec__9989,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
