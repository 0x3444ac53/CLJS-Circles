...
var G__9994 = devtools.prefs.pref.call(null,v);
v = G__9994;
continue;
} else {
return v;
...
}catch (e9997){var _e__9011__auto__ = e9997;
return false;
}})();
...
}catch (e10001){var _e__9011__auto__ = e10001;
return false;
}})();
...
}catch (e10003){var _e__9011__auto__ = e10003;
return false;
}}
}
});
...
var vec__10005 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10005,(0),null);
var name = cljs.core.nth.call(null,vec__10005,(1),null);
...
return cljs.core.some.call(null,(function (p1__10008_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10008_SHARP_);
}),template);
});
