...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__10723_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_10724 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_10725 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_10724);
var pos_10726 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_10724);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_10725);

var tr__10616__auto___10727 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_10725) - cljs.core.first(pos_10726)),(((quil.core.height() / (2)) / zoom_10725) - cljs.core.second(pos_10726))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__10616__auto___10727);
...
var G__10728 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__10729 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__10728,G__10729) : user_mouse_dragged.call(null,G__10728,G__10729));
...
return (function (state,event){
var G__10730 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__10731 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__10730,G__10731) : user_mouse_wheel.call(null,G__10730,G__10731));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
