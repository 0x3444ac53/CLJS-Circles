...
var map__15043 = top_item;
var map__15043__$1 = ((((!((map__15043 == null)))?(((((map__15043.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15043.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15043):map__15043);
var file = cljs.core.get.call(null,map__15043__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15043__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15043__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15042){var _e = e15042;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___15045 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___15045)){
var seen_errors_15046 = temp__5718__auto___15045;
if(cljs.core.truth_(seen_errors_15046.has(self))){
} else {
seen_errors_15046.add(self);

var temp__5720__auto___15047 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___15047)){
var sense_15048 = temp__5720__auto___15047;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_15048)].join('');
} else {
}
}
} else {
