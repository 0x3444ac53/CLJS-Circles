...
var G__10573 = devtools.prefs.pref.call(null,v);
v = G__10573;
continue;
} else {
return v;
...
}catch (e10576){var _e__9470__auto__ = e10576;
return false;
}})();
...
}catch (e10580){var _e__9470__auto__ = e10580;
return false;
}})();
...
}catch (e10582){var _e__9470__auto__ = e10582;
return false;
}}
}
});
...
var vec__10584 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__10584,(0),null);
var name = cljs.core.nth.call(null,vec__10584,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10587_SHARP_);
}),template);
});
