...
var o10453 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10453["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10454 = temp__5718__auto____$1;
return (o10454["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9463__auto__ = f;
return (o__9463__auto__["toString"]).call(o__9463__auto__);
} else {
return "";
}
}catch (e10455){var _ = e10455;
return "";
}});
...
try{var o__9463__auto___10457 = t;
(o__9463__auto___10457["cljs$lang$ctorPrWriter"]).call(o__9463__auto___10457,t,writer);
}catch (e10456){var __10458 = e10456;
}
...
var char_code = (function (){var o__9463__auto__ = (new String(char$));
return (o__9463__auto__["charCodeAt"]).call(o__9463__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9463__auto__ = String;
return (o__9463__auto__["fromCharCode"]).call(o__9463__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10459 = num_code;
switch (G__10459) {
case (1):
return (185);
...
var o__9463__auto__ = String;
return (o__9463__auto__["fromCharCode"]).call(o__9463__auto__,superscript_code);
});
/**
...
}catch (e10461){var _e__9470__auto__ = e10461;
return false;
}})())){
...
var vec__10462 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10462,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o10465 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10465["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10466 = temp__5718__auto____$1;
return (o10466["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10469){
var vec__10470 = p__10469;
var ns_detector = cljs.core.nth.call(null,vec__10470,(0),null);
...
var G__10476 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10477 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10476;
remaining_tokens = G__10477;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10467){
var G__10468 = cljs.core.first.call(null,seq10467);
var seq10467__$1 = cljs.core.next.call(null,seq10467);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10468,seq10467__$1);
});
...
var vec__10481 = cljs.core.split_with.call(null,(function (p1__10480_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10480_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10481,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10481,(1),null);
...
var vec__10484 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10484,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10484,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10487 = cljs.core.rest.call(null,remaining_tokens);
var G__10488 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10487;
name_tokens = G__10488;
continue;
} else {
...
var vec__10491 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10491,(0),null);
var arity = cljs.core.nth.call(null,vec__10491,(1),null);
var vec__10494 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10494,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10494,(1),null);
var vec__10497 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10497,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10497,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10497,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10497,(3),null);
...
var vec__10503 = result;
var munged_ns = cljs.core.nth.call(null,vec__10503,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10503,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10503,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10503,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10503,(4),null);
var arity = cljs.core.nth.call(null,vec__10503,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__10507 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__10507,(0),null);
var args = cljs.core.nth.call(null,vec__10507,(1),null);
var vec__10510 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10510,(0),null);
var name = cljs.core.nth.call(null,vec__10510,(1),null);
...
var G__10513 = (arity + (1));
var G__10514 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10515){
var vec__10516 = p__10515;
var arity = cljs.core.nth.call(null,vec__10516,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10516,(1),null);
...
return (function (p1__10519_SHARP_){
return cljs.core.get.call(null,arities,p1__10519_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10520_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___10527 = arguments.length;
var i__4532__auto___10528 = (0);
while(true){
if((i__4532__auto___10528 < len__4531__auto___10527)){
args__4534__auto__.push((arguments[i__4532__auto___10528]));

var G__10529 = (i__4532__auto___10528 + (1));
i__4532__auto___10528 = G__10529;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10523){
var vec__10524 = p__10523;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10524,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10521){
var G__10522 = cljs.core.first.call(null,seq10521);
var seq10521__$1 = cljs.core.next.call(null,seq10521);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10522,seq10521__$1);
});
...
var map__10532 = options;
var map__10532__$1 = ((((!((map__10532 == null)))?(((((map__10532.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10532.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10532):map__10532);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10532__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10532__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10532__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10532__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10533 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10533,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10533,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10533,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10533,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10533,(4),null);
var arity = cljs.core.nth.call(null,vec__10533,(5),null);
...
var o__9463__auto__ = f;
return (o__9463__auto__["getBasis"]).call(o__9463__auto__);
});
/**
...
}catch (e10537){var _e__9470__auto__ = e10537;
...
var G__10538 = (obj[cljs.core.first.call(null,path)]);
var G__10539 = cljs.core.rest.call(null,path);
obj = G__10538;
path = G__10539;
continue;
} else {
...
return (function (accum,p__10540){
var vec__10541 = p__10540;
var bit = cljs.core.nth.call(null,vec__10541,(0),null);
var protocol = cljs.core.nth.call(null,vec__10541,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10544){
var vec__10545 = p__10544;
var ns = cljs.core.nth.call(null,vec__10545,(0),null);
var name = cljs.core.nth.call(null,vec__10545,(1),null);
var selector = cljs.core.nth.call(null,vec__10545,(2),null);
...
return (function (p__10549){
var vec__10550 = p__10549;
var munged_name = cljs.core.nth.call(null,vec__10550,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10550,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10550,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10548_SHARP_){
return (obj[cljs.core.first.call(null,p1__10548_SHARP_)]);
});})(name,sorted_matches,vec__10550,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
