...
var vec__8815 = axis;
var a_x = cljs.core.nth.call(null,vec__8815,(0),null);
var a_y = cljs.core.nth.call(null,vec__8815,(1),null);
var a_z = cljs.core.nth.call(null,vec__8815,(2),null);
var vec__8818 = v;
var x = cljs.core.nth.call(null,vec__8818,(0),null);
var y = cljs.core.nth.call(null,vec__8818,(1),null);
var z = cljs.core.nth.call(null,vec__8818,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__8821,p__8822){
var vec__8823 = p__8821;
var u1 = cljs.core.nth.call(null,vec__8823,(0),null);
var u2 = cljs.core.nth.call(null,vec__8823,(1),null);
var u3 = cljs.core.nth.call(null,vec__8823,(2),null);
var vec__8826 = p__8822;
var v1 = cljs.core.nth.call(null,vec__8826,(0),null);
var v2 = cljs.core.nth.call(null,vec__8826,(1),null);
var v3 = cljs.core.nth.call(null,vec__8826,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__8829_SHARP_){
return (p1__8829_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__8830_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__8831_SHARP_,angle_lr),angle_ud);
...
var map__8833 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__8833__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__8833__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5718__auto__ = (function (){var pred__8835 = cljs.core._EQ_;
var expr__8836 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__8835.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__8836))){
return straight;
} else {
if(cljs.core.truth_(pred__8835.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__8836))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__8835.call(null,quil.middlewares.navigation_3d.space,expr__8836))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__8835.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__8836))){
return up;
} else {
if(cljs.core.truth_(pred__8835.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__8836))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__8835.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__8836))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5718__auto__,map__8833,map__8833__$1,up,straight){
return (function (p1__8832_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__8832_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5718__auto__,map__8833,map__8833__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__8838_SHARP_);
});})(initial_state))
);
});
/**
...
var map__8839_8850 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__8839_8851__$1 = ((((!((map__8839_8850 == null)))?(((((map__8839_8850.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__8839_8850.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8839_8850):map__8839_8850);
var vec__8840_8852 = cljs.core.get.call(null,map__8839_8851__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_8853 = cljs.core.nth.call(null,vec__8840_8852,(0),null);
var c_y_8854 = cljs.core.nth.call(null,vec__8840_8852,(1),null);
var c_z_8855 = cljs.core.nth.call(null,vec__8840_8852,(2),null);
var vec__8843_8856 = cljs.core.get.call(null,map__8839_8851__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_8857 = cljs.core.nth.call(null,vec__8843_8856,(0),null);
var u_y_8858 = cljs.core.nth.call(null,vec__8843_8856,(1),null);
var u_z_8859 = cljs.core.nth.call(null,vec__8843_8856,(2),null);
var vec__8846_8860 = cljs.core.get.call(null,map__8839_8851__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_8861 = cljs.core.nth.call(null,vec__8846_8860,(0),null);
var p_y_8862 = cljs.core.nth.call(null,vec__8846_8860,(1),null);
var p_z_8863 = cljs.core.nth.call(null,vec__8846_8860,(2),null);
quil.core.camera.call(null,p_x_8861,p_y_8862,p_z_8863,(p_x_8861 + c_x_8853),(p_y_8862 + c_y_8854),(p_z_8863 + c_z_8855),u_x_8857,u_y_8858,u_z_8859);
